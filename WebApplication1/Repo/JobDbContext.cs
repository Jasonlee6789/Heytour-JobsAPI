    ...
    {//数据库上下文主要是作为承前启后的左右存在，它保存着一切支撑数据库与程序访问的内容。
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<HeytourJob>().HasData(new HeytourJob { Id = 1, IsActive = true, Title = "Fu Er Dai", Location = "Watchtower, Washington", Company = "QUORDATE", Email = "frankhorton@quordate.com", Industry = "Rich", JobDesc = "Veniam laborum veniam commodo veniam nisi commodo. Culpa elit qui deserunt adipisicing ad dolor proident laboris adipisicing tempor eu. Elit do non occaecat exercitation ullamco deserunt. Aliquip labore consectetur elit id. Voluptate cupidatat dolore eiusmod labore eu. Consectetur ipsum mollit tempor eiusmod id ipsum sit.", Picture = "https://i.picsum.photos/id/703/300/150.jpg?hmac=u4EJJhnL7eJiV1Ub0wJ5El9hPvAeZvfIIJuKvVFtNus", PostedOn = DateTime.Parse("2020-12-11T04:48:37") },
                ...
                new HeytourJob { Id = 7, IsActive = false, Title = "Teacher Aide", Location = "Hoagland, Oklahoma", Company = "CAXT", Email = "frankhorton@caxt.com", Industry = "Education", JobDesc = "Ea nostrud reprehenderit dolore magna duis Lorem qui deserunt ipsum nisi nulla voluptate non. Sunt id reprehenderit nulla officia consequat aute incididunt ut excepteur occaecat excepteur incididunt. Voluptate non nostrud enim proident incididunt commodo culpa enim incididunt ut est sint labore magna. Ipsum aliqua consectetur nostrud laborum minim velit.", Picture = "https://i.picsum.photos/id/915/300/150.jpg?hmac=gHfv_JAFqDL7lQRpAkYZBBwHkirJDaTJ1pB4e0wBrsw", PostedOn = DateTime.Parse("2020-04-24T02:43:09") });
