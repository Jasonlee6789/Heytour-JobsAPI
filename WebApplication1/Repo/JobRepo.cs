        ...
        public IEnumerable<Heytour> GetJobs()   
        {
            var jobs = new List<Heytour>()

             {
                ...
                {new Heytour { Id = 7, IsActive = false, Title = "Teacher Aide", Location="Hoagland, Oklahoma", Company ="CAXT",  Email="frankhorton@caxt.com", Industry="Education", JobDesc="Ea nostrud reprehenderit dolore magna duis Lorem qui deserunt ipsum nisi nulla voluptate non. Sunt id reprehenderit nulla officia consequat aute incididunt ut excepteur occaecat excepteur incididunt. Voluptate non nostrud enim proident incididunt commodo culpa enim incididunt ut est sint labore magna. Ipsum aliqua consectetur nostrud laborum minim velit.", Picture="https://i.picsum.photos/id/915/300/150.jpg?hmac=gHfv_JAFqDL7lQRpAkYZBBwHkirJDaTJ1pB4e0wBrsw", PostedOn=DateTime.Parse("2020-04-24T02:43:09") } },
            };
